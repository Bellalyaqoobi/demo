...
const Utils = {
    ...
    showToast: (message, type = 'info') => {
        // بررسی وجود المنت toast
        let toast = document.getElementById('toastNotification');
        
        // اگر toast وجود نداشت، یک toast موقت ایجاد کن
        if (!toast) {
    ...
    addDebouncedEventListener: (element, event, handler, wait = 300) => {
        ...
        // استفاده از this.debounce به جای Utils.debounce
    ...
    paginate: (array, page = 1, perPage = 10) => {
        if (!Array.isArray(array)) {
            return { data: [], currentPage: 1, totalPages: 0, totalItems: 0, perPage };
        }
...
// اطمینان از وجود Utils در فضای global
window.Utils = Utils;
...
// برای debugging - بررسی کنید که Utils لود شده است
